    ...
    <div class="quick-actions_homepage">
        <ul class="quick-actions">
            <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'vCliente')) : ?>
                <li class="bg_lb">
                    <a href="<?= base_url() ?>index.php/clientes"> <i class="fas fa-users" style="font-size:36px"></i>
                        <div>Clientes: <?= $this->db->count_all('clientes'); ?></span></div>
                    </a>
                </li>
            <?php endif ?>
            ...
            <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'vVeiculo')) : ?>
                <li class="bg_lg">
                    <a href="<?= base_url() ?>index.php/veiculos"> <i class="fas fa-car" style="font-size:36px"></i>
                        <div>Veiculos: <?= $this->db->count_all('veiculos'); ?></span></div>
                    </a>
                </li>
            <?php endif ?>
            ...
            <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'vMensalidade')) : ?>
                <li class="bg_ly">
                    <a href="<?= base_url() ?>index.php/mensalidades"> <i class="fas fa-money-check-alt" style="font-size:36px"></i>
                        <div>Mensalidades: <?= $this->db->count_all('mensalidades'); ?></span></div>
                    </a>
                </li>
            <?php endif ?>
            ...
            <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'vOs')) : ?>
                <li class="bg_lo">
                    <a href="<?= base_url() ?>index.php/os"> <i class="fas fa-diagnoses" style="font-size:36px"></i>
                        <div>OS: <?= $this->db->count_all('os'); ?></span></div>
                    </a>
                </li>
            <?php endif ?>
            ...
            <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'vVenda')) : ?>
                <li class="bg_ls">
                    <a href="<?= base_url() ?>index.php/vendas"><i class="fas fa-cash-register" style="font-size:36px"></i>
                        <div>Vendas: <?= $this->db->count_all('vendas'); ?></span></div>
                    </a>
                </li>
            <?php endif ?>
            ...
            <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'vProduto')) : ?>
                <li class="bg_lv">
                    <a href="<?= base_url() ?>index.php/produtos"><i class="fas fa-cubes" style="font-size:36px"></i>
                        <div>Produtos: <?= $this->db->count_all('produtos'); ?></span></div>
                    </a>
                </li>
            <?php endif ?>
        </ul>
