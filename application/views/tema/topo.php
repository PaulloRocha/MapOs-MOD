...
<head>
  ...
  <script type="text/javascript">
    ...
    shortcut.add("F2", function() {
      location.href = '<?php echo base_url(); ?>index.php/veiculos';
    });
    shortcut.add("F3", function() {
      location.href = '<?php echo base_url(); ?>index.php/mensalidades';
    });
    ...
    <ul>
      ...
      <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'vVeiculo')) { ?>
        <li class="<?php if (isset($menuVeiculos)) {
                        echo 'active';
                      }; ?>"><a href="<?php echo base_url() ?>index.php/veiculos"><i class="fas fa-car"></i> <span>Veiculos</span></a></li>
      <?php
      } ?>
      <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'vMensalidade')) { ?>
        <li class="<?php if (isset($menuMensalidades)) {
                        echo 'active';
                      }; ?>"><a href="<?php echo base_url() ?>index.php/mensalidades"><i class="fas fa-money-bill-alt"></i> <span>Mensalidades</span></a></li>
      <?php
      } ?>
      ...
      <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'rCliente') || $this->permission->checkPermission($this->session->userdata('permissao'), 'rProduto') || 
      $this->permission->checkPermission($this->session->userdata('permissao'), 'rVeiculo') || 
      $this->permission->checkPermission($this->session->userdata('permissao'), 'rMensalidade') || 
      $this->permission->checkPermission($this->session->userdata('permissao'), 'rServico') || $this->permission->checkPermission($this->session->userdata('permissao'), 'rOs') || $this->permission->checkPermission($this->session->userdata('permissao'), 'rFinanceiro') || $this->permission->checkPermission($this->session->userdata('permissao'), 'rVenda')) { ?>
        <li class="submenu <?php if (isset($menuRelatorios)) {
          ...
          <ul>
            ...
            <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'rVeiculo')) { ?>
              <li><a href="<?php echo base_url() ?>index.php/relatorios/veiculos">Veiculos</a></li>
            <?php
              } ?>
