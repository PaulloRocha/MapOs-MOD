<div class="widget-box">
    <div class="widget-title">
        <ul class="nav nav-tabs">
            ...
            <li><a data-toggle="tab" href="#tab3">Veículos</a></li>
            <div class="buttons">
                    ...
                    <tbody>
                        <?php
                            foreach ($results as $r) {                                
                                ...
                                echo '<td>';
                                if ($this->permission->checkPermission($this->session->userdata('permissao'), 'vVeiculos')) {
                                ...
                                if ($this->permission->checkPermission($this->session->userdata('permissao'), 'eVeiculos')) {
