...
<div class="container-fluid">
    <div class="quick-actions_homepage">
        <ul class="quick-actions">
            ...
            <li class="bg_lb">           
                <a href="<?= base_url() ?>index.php/clientes"> <i class="icon-group"></i> Clientes:  <?= $this->db->count_all('clientes'); ?></strong> <small></small></li></a>               
            </li>
            <?php endif ?>    

            <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'vVeiculo')) : ?>
            <li class="bg_lv">
                <a href="<?= base_url() ?>index.php/veiculos"><i class="icon-truck" ></i> Veiculos: <?= $this->db->count_all('veiculos'); ?></strong> <small></small></li></a>
            </li>
            <?php endif ?>
            
            <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'vMensalidade')) : ?>
            <li class="bg_ls">
                <a href="<?= base_url() ?>index.php/mensalidades"><i class="icon-money" ></i> Mensalidades: <?= $this->db->count_all('mensalidades'); ?></strong> <small></small></li></a>
            </li>
            <?php endif ?>
            
            <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'vServico')) : ?>
            <li class="bg_ly">
                <a href="<?= base_url() ?>index.php/servicos"> <i class="icon-wrench"></i> Serviços: <?= $this->db->count_all('servicos'); ?></strong> <small></small></li></a>
            </li>
            <?php endif ?>

            <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'vOs')) : ?>
            <li class="bg_lo">
                <a href="<?= base_url() ?>index.php/os"> <i class="icon-tags"></i> OS: <?= $this->db->count_all('os'); ?></strong> <small></small></li></a>
            </li>
            <?php endif ?>

            <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'vVenda')) : ?>
            <li class="bg_lg">
                <a href="<?= base_url() ?>index.php/vendas"><i class="icon-shopping-cart"></i> Vendas: <?= $this->db->count_all('vendas'); ?></strong> <small></small></li></a>
            </li>
            <?php endif ?>
                ...
                <div class="row-fluid">
                    <div class="span12">
                        <ul class="site-stats">
                            ...
                            <li class="bg_lh"><i class="icon-truck"></i> <strong>
                                    <?= $this->db->count_all('veiculos'); ?></strong> <small>Veiculos</small></li>
